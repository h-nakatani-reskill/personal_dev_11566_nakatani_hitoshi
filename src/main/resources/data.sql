--ユーザーテーブルデータ
INSERT INTO users(name,email,password) VALUES('田中一郎','i.tanaka.@daiichi.ed.jp','tanaka123');
INSERT INTO users(name,email,password) VALUES('鈴木次郎','j.suzuki@daiichi.ed.jp','suzuki456');
INSERT INTO users(name,email,password) VALUES('加藤三郎','s.kato@daiichi.ed.jp','kato789');
...
INSERT INTO tasks(category_id,user_id,record_day,title,level,progress,memo) VALUES(5,1, '2003-06-23', '保湿剤',20,1, '第一関節ぐらいの量');
INSERT INTO tasks(category_id,user_id,record_day,title,level,progress,memo) VALUES(3,1, '2022-05-28', '高血圧薬', 22,2,'夕食後');
INSERT INTO tasks(category_id,user_id,record_day,title,level,progress,memo) VALUES(5,1, '2025-12-24', '軟膏', 20,2,'お茶はNG');
...
INSERT INTO tasks(category_id,user_id,record_day,title,level,progress,memo) VALUES(4,2, '2004-09-30', '風邪薬', 20,2,'毎食後');
...
INSERT INTO tasks(category_id,user_id,record_day,title,level,progress,memo) VALUES(2,1, '2021-08-16', '酔い止め', 22,2,'乗車前');